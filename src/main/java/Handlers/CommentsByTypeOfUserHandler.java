 ...
 * @author user1
 */
public class CommentsByTypeOfUserHandler {
   public JSONObject bringCommentsByTypeOfUserHandler(HttpServletRequest request, DaoHotels daohotel, DaoSentence daoSen) {
        ...
        try {
            ...
            if (Hotel.getHoteName() != null) {
                ...
                List<CommentBean> allComments = daohotel.getAllCommentsByHotelIdAndTypeOfUserLimit(Hotel.getHotelId(),request.getParameter("TypeOfUser"), Integer.parseInt(request.getParameter("start")), Integer.parseInt(request.getParameter("end")));
