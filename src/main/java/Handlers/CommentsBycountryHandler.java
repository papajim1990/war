 ...
 * @author user1
 */
public class CommentsBycountryHandler {

    public JSONObject bringCommentsByCountry(HttpServletRequest request, DaoHotels daohotel, DaoSentence daoSen) {
        ...
        try {
            ...
            if (Hotel.getHoteName() != null) {
                ...
                List<CommentBean> allComments = daohotel.getAllCommentsByHotelIdAndCountryLimit(Hotel.getHotelId(),request.getParameter("Country"), Integer.parseInt(request.getParameter("start")), Integer.parseInt(request.getParameter("end")));
