 ...
 * @author user1
 */
public class CommentsAllHandler {

    public JSONObject bringCommentsAll(HttpServletRequest request, DaoHotels daohotel, DaoSentence daoSen) {
        ...
        try {
            ...
            if (Hotel.getHoteName() != null) {
                try {
                    ...
                    List<CommentBean> allComments = daohotel.getCommentsAllByHotelId(Hotel.getHotelId(), Integer.parseInt(request.getParameter("start")), Integer.parseInt(request.getParameter("end")));
                    int numberofcomments=daohotel.getCountByHotelIdAndAll(Hotel.getHotelId());
